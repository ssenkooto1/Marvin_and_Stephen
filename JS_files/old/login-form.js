$(document).ready(function(){
    ...
    var bussinessname =$(".bussiness-name").val();  
    ...
    if(!phonenumber.match(check)){
        $(".phone-number-hide").text("Enter your valid Phone Number");
            return false;
    }
    else{true;}
    ...
    // bussiness name
            if(bussinessname==""){
                $(".bussiness-name-hide").text("Enter your Business");
                return false;
            }
            else{true;}
            if(!bussinessname.match(check)){
                $(".bussiness-name-hide").text("Enter your valid Business name");
                    return false;
            }
            else{true;}
